			...
			<div class="enter_in">
				...
				<div class="center">
					...
					<div class="main">
						...
						<form method="post" action="${ pageContext.request.contextPath }/user/signin" id="ctl00">
							...
							<input type="hidden" name="user.other" value="${user.other}" />
							<input name="user.permission" type="hidden" value="1" />
						</form>
					</div>
					<div class="user_new">
						<p>
