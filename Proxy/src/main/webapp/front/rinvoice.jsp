...
<div class="wrapper wrapper-content animated fadeInRight">
    <form method="post" action="${ pageContext.request.contextPath}/recharge/alipay.do">
        <div class="row">
            <div class="col-sm-12">
                <div class="ibox-content p-xl">
                    ...
                    <div class="table-responsive m-t">
                        <table class="table invoice-table">
                            ...
                            <tr>
                                <td>
                                    <div><strong>账户余额充值</strong>
                                    </div>
                                </td>
                                <td>1</td>
                                <td>&yen;${requestScope.recharge.amount}元</td>
                                <td>&yen;${requestScope.recharge.amount}元</td>
                            </tr>
                            </tbody>
                        </table>
                    ...
                    <input type="hidden" value="${requestScope.recharge.username}" name="username"/>
                    <input type="hidden" value="${requestScope.recharge.amount}" name="amount"/>
                    <input type="hidden" value="${requestScope.recharge.status}" name="status"/>
                    <div class="text-right">
                        <button class="btn btn-primary" type="submit"><i class="fa fa-dollar"></i> 去付款</button>
                    </div>

                    <div class="well m-t"><strong>注意：</strong> 请立即完成付款，否则订单会自动取消。
                    </div>
                </div>
            </div>
        </div>
