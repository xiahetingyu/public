                        ...
                        <table class="table table-hover">
                            ...
                            <c:forEach items="${ requestScope.recharges}" var="recharge" varStatus="e">
                                <tr>
                                    ...
                                    <td class="project-actions">
                                        <a href="${ pageContext.request.contextPath}/recharge/deletes.do?ids=${recharge.id}&username=${sessionScope.user.username}&condition=${requestScope.page.condition}&content=${requestScope.page.content}&size=10000&other=/front/rhistory.jsp"
...
<script>
    function search() {
        ...
        window.location.href = "${pageContext.request.contextPath}/recharge/selectps.do?username=${sessionScope.user.username}&condition=" + condition + "&content=" + content + "&size=10000&other=/front/rhistory.jsp";
    }<!--模糊查询-->
</script>
