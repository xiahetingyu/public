...
<body class="gray-bg">
<form method="post" action="${ pageContext.request.contextPath}/recharge/generate.do">
    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="panel blank-panel">
                                <div class="col-sm-12">
                                    <div class="m-b-md">
                                        <h2>账户充值</h2>
                                        <span class="label">当前账户余额：￥${(empty requestScope.other.balance)?0:requestScope.other.balance}元</span>
                                    </div>
                                </div>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="tab-1">
                                            <table class="table table-striped">
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="radio" value="1" name="other"/>
                                                    </td>
                                                    <td>
                                                        1
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="radio" value="5" name="other"/>
                                                    </td>
                                                    <td>
                                                        2
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="radio" value="10" name="other" checked="checked"/>
                                                    </td>
                                                    <td>
                                                        3
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="radio" value="20" name="other"/>
                                                    </td>
                                                    <td>
                                                        4
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="radio" value="50" name="other"/>
                                                    </td>
                                                    <td>
                                                        5
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div style="margin-left: 100px">
                                                            除了选择以上套餐你还可以自定义充值金额：<input type="text" name="username"/>
                                                        </div>
                                                    </td>
                                                    <td>
