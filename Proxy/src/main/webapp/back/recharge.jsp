                ...
                <section class="panel">
                    ...
                    <table class="table table-striped table-advance table-hover">
                        ...
                        <tr><!--  表头 -->
                            ...
                            <th><i class="icon_pin_alt"></i> 订单金额</th>
                            <th><i class="icon_mail_alt"></i> 支付状态</th>
                            <th><i class="icon_calendar"></i> 日期</th>
                            <th><i class="icon_cogs"></i> 删除</th>
                        </tr>
                        <form method="post" action="${ pageContext.request.contextPath}/recharge/deletes.do">
                            ...
                            <c:forEach items="${ requestScope.recharges}" var="recharge" varStatus="e">
                            <!-- 表体 -->
                            <tr>
                                ...
                                <td>
                                        ${ recharge.status gt 0?"支付成功":"支付失败"}
                                </td>
                                <td>${ recharge.time }</td>
                                <!-- 表格的操作 -->
                                <td>
                                    <a class="btn btn-danger"
                                       href="${ pageContext.request.contextPath}/recharge/deletes.do?ids=${recharge.id}&index=${requestScope.page.index}&condition=${requestScope.page.condition}&content=${requestScope.page.content}">删除</a>
                                </td>
                            </tr>
                            </c:forEach>
                        </tbody>
                    ...
                    <div style="float: right;margin-right: 100px">
                        <ul class="pagination pagination-rg">
                            <li>
                                <a href="${ pageContext.request.contextPath}/recharge/selectps.do?index=0&condition=${requestScope.page.condition}&content=${requestScope.page.content}">首页</a>
                            </li>
                            <li>
                                <a ${(requestScope.page.index gt 0)?"":"style='pointer-events:none;'"}
                                        href="${ pageContext.request.contextPath}/recharge/selectps.do?index=${requestScope.page.index-1}&condition=${requestScope.page.condition}&content=${requestScope.page.content}">上一页</a>
                            </li>
                            <li>
                                <a ${(requestScope.page.index lt requestScope.page.count-1)?"":"style='pointer-events:none;'"}
                                        href="${ pageContext.request.contextPath}/recharge/selectps.do?index=${requestScope.page.index+1}&condition=${requestScope.page.condition}&content=${requestScope.page.content}">下一页</a>
                            </li>
                            <li>
                                <a href="${ pageContext.request.contextPath}/recharge/selectps.do?index=${requestScope.page.count-1}&condition=${requestScope.page.condition}&content=${requestScope.page.content}">尾页</a>
                            </li>
                        </ul>
                    </div>
                    <!--批量删除和页号展示-->
...
<script>
    function search() {
        ...
        window.location.href = "${pageContext.request.contextPath}/recharge/selectps.do?condition=" + condition + "&content=" + content;
    }<!--模糊查询-->
